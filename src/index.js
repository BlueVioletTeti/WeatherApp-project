...
function showTemperature(response) {
  ...
  //Forecast
  if (unitDisplayMetric === true) {
    getForecastInC(response.data.coord);
  } else {
    getForecastInF(response.data.coord);
  }
}
...
function getForecastInC(coordinates) {
  let apiKey = "0774011ae8c6615118624b282251a3f1";
  let apiUrl = `https://api.openweathermap.org/data/2.5/onecall?lat=${coordinates.lat}&lon=${coordinates.lon}&appid=${apiKey}&units=metric`;
  axios.get(apiUrl).then(displayForecast);
}

function getForecastInF(coordinates) {
  let apiKey = "0774011ae8c6615118624b282251a3f1";
